            ...
            <Transition show={isModalOpen}>
                ...
                <Transition.Child
                    ...
                    <div
                        ...
                        <div
                            className={`sm:w-full w-11/12 py-10 px-10 bg-light-100 border border-[#707070] rounded-xl ${
                                classes ? classes : 'max-w-[64rem]'
                            }`}>
                            ...
                            {content && <div className="text-sm pt-6 pb-4 px-2 sm:px-8 text-center">{content}</div>}
